...
def embed_chunks(chunks: List[Dict[str, Any]], batch_size: int = DEFAULT_BATCH_SIZE, timeout: float = 30.0) -> List[List[float]]:
...
def embed_texts(texts: List[str], batch_size: int = DEFAULT_BATCH_SIZE, timeout: float = 30.0) -> List[List[float]]:
